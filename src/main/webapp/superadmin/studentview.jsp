    ...
    <div class="container-fluid">
      ...
      <div class="container">
        <nav class="navbar navbar-dark bg-dark justify-content-between">
          <h2 class="navbar-brand mr-auto ml-auto">Student List</h2>
        </nav>
        <div class="home">
          <div class="container h-100">
            <div class="d-flex justify-content-center h-100">
              <div class="user_card">
				...
				<form name="addadmin_form" action="<%=request.getContextPath() %>/superadmin/studentview" method="post">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="text" name="roll_no" class="form-control input_user" required="required" placeholder="Roll Number">
                    </div>
