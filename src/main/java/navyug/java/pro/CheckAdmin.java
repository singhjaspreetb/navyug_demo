...
public class CheckAdmin {
	public static Admin check(Connection conn,String userId,String empId) throws SQLException {
//		String sql = "select * from student_auth where username = ? and password = ?";
		String sql = "select * from auth_admin where admin_id = '"+userId+"' and name = '"+empId+"';";
